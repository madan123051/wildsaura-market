  ...
  return (
    <Modal onClose={onClose} maxWidth={420}>
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ background: '#1f2126', border: '1px solid #2e323a', borderRadius: 12, padding: '0.7rem 1rem', color: '#8a8f98', fontSize: '0.8rem', marginBottom: '1.2rem', wordBreak: 'break-all', textAlign: 'left' }}>🔗 {communityUrl}</div>
